...
describe('당첨 번호 입력 예외', () => {
  ...
  )(',을 기준으로 6개 숫자가 아닌 입력', async(input) => {
    await runException(
      [...INPUT_STARTS, input, ...INPUT_ENDS],
...
describe('보너스 번호 입력 예외', () => {
  ...
  )('당첨 번호와 중복되는 입력', async(winningNumbers, bonnusNumber) => {
    await runException(
